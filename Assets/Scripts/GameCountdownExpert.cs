...
public class GameCountdownExpert : MonoBehaviour
{
    ...
    public GameObject RockBlue;
    public GameObject RockYellow;
    public GameObject Paper;
    public GameObject PaperBlue;
    public GameObject PaperRed;
    public GameObject Scissors;
    public GameObject ScissorsRed;
    public GameObject ScissorsYellow;
    ...
    void Update()
    {
      ...
      if(countdown > -0.3)
      {
        countdown -= Time.deltaTime * speedup;
        ...
        if(countdown <= 1.0)
        {
          ...
          if(handRandom == 3)
          {
            RockBlue.SetActive(true);
          }
          if(handRandom == 4)
          {
            RockYellow.SetActive(true);
          }
          if(handRandom == 5)
          {
            PaperRed.SetActive(true);
          }
          if(handRandom == 6)
          {
            PaperBlue.SetActive(true);
          }
          if(handRandom == 7)
          {
            ScissorsRed.SetActive(true);
          }
          if(handRandom == 8)
          {
            ScissorsYellow.SetActive(true);
          }
        }
        ...
        if(countdown >= -0.2 && countdown <= 1.0)
        {
          ...
          if(handRandom >= 3 && handRandom <= 4 && answered == 0 && WinLoseRandom == 0)
          {
            WinRockQuestioned();
          }
          ...
          if(handRandom >= 5 && handRandom <= 6 && answered == 0 && WinLoseRandom == 0)
          {
            WinPaperQuestioned();
            }
          ...
          {
            WinScissorsQuestioned();
          }
          if(handRandom >= 7 && handRandom <= 8 && answered == 0 && WinLoseRandom == 0)
          {
            WinScissorsQuestioned();
          }
        ...
        if(handRandom >= 3 && handRandom <= 4 && answered == 0 && WinLoseRandom == 1)
        {
          LoseRockQuestioned();
        }
        ...
        if(handRandom >= 5 && handRandom <= 6 && answered == 0 && WinLoseRandom == 1)
        {
          LosePaperQuestioned();
        }
        ...
        {
          LoseScissorsQuestioned();
        }
        if(handRandom >= 7 && handRandom <= 8 && answered == 0 && WinLoseRandom == 1)
        {
          LoseScissorsQuestioned();
        }
      }
  ...
  public void WinPaperQuestioned()
  {
    if(ButtonRock.GetComponent<RockPressed>().rockSelect == true)
    {
      answered++;
  ...
  public void WinScissorsQuestioned()
  {
    if(ButtonRock.GetComponent<RockPressed>().rockSelect == true)
    {
      answered++;
  ...
  public void LoseRockQuestioned()
  {
    if(ButtonRock.GetComponent<RockPressed>().rockSelect == true)
    {
      answered++;
  ...
  public void LosePaperQuestioned()
  {
    if(ButtonRock.GetComponent<RockPressed>().rockSelect == true)
    {
      answered++;
  ...
  public void LoseScissorsQuestioned()
  {
    if(ButtonRock.GetComponent<RockPressed>().rockSelect == true)
    {
      answered++;
    ...
    public void reset()
    {
      ...
      RockBlue.SetActive(false);
      RockYellow.SetActive(false);
      PaperBlue.SetActive(false);
      PaperRed.SetActive(false);
      ScissorsRed.SetActive(false);
      ScissorsYellow.SetActive(false);
